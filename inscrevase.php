			...
			<form method="post" action="registra_usuario.php" id="form_cadastrarse">
						...
						<div class="form-group">
							...
							<div class="btn-group" data-toggle="buttons">
								...
								<label class="btn btn-default">
									<input type="radio" name="sexo" id="inputSexo" value="M" required="requiored">
									Masculino 
								</label>

								<label class="btn btn-default">
									<input type="radio" name="sexo" id="inputSexo" value="F" required="requiored">
									Feminino 
								</label>
							</div>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="form-group">
							<input type="password" class="form-control"  name="senha" placeholder="*Senha" required="requiored" id="senha">
						</div>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="form-group">
							<input type="password" class="form-control"  name="confirmaSenha" placeholder="*Confirma Senha" required="requiored" id="confirmaSenha">
						</div>
